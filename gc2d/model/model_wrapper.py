class ModelWrapper:
    ...
    def set_data_z_offset(self, data_z_offset):
        ...
        :return: Nothing
        """
        self.__model.data_z_offset = data_z_offset

    def get_period(self):
        """
        :return: the period of the data.
        """
        return self.__model.period
