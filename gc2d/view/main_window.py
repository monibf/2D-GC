...
from gc2d.controller.action.new_selector_action import NewSelectorAction
...
class Window(QMainWindow):
    ...
    def __init__(self, model_wrapper):
        ...
        self.new_selector_action = NewSelectorAction(self, self.model_wrapper)
    ...
    def create_menus(self):
        ...
        edit_menu.addAction(self.new_selector_action)
