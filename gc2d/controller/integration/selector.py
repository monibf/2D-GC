...
class Selector(QObject):
    ...
    def __init__(self, model_wrapper, mouse_position, label=None, handles=None, pos=None):
        """ 
    ...
    def add_point(self, mouse_position):
        ...
        :return: None
        """
        positions = self.roi.getLocalHandlePositions()
        self.points = [element[1] for element in positions]
